...
namespace bbxBE.Common.Consts
{
    public static  class bbxBEConsts
    {
        ...
        public static string ERR_INVAGGR_RELATED_NOT_ASSIGNED = "A gyűjtőszámlán lévő tételhez nincs szállítólevél rendelve! Bizonylatszám:{0}, sor száma:{1}, temékkód:{3} ";
        public static string ERR_INVAGGR_RELATED_NOT_FOUND = "A gyűjtőszámlán lévő tételhez nem található szállítólevél! Bizonylatszám:{0}, sor száma:{1}, temékkód:{3}, kapcsolt szállító-sor ID:{4} ";
