...
namespace bbxBE.Infrastructure.Persistence.Repositories
{
    public class VatRateRepositoryAsync : GenericRepositoryAsync<VatRate>, IVatRateRepositoryAsync
    {
        ...
        public Entity GetVatRate(long ID)
        {
            ...
            // shape data
            var shapedData = _dataShaperGetVatRateViewModel.ShapeData(itemModel, String.Join(",", listFieldsModel));
        ...
        public async Task<(IEnumerable<Entity> data, RecordsCount recordsCount)> QueryPagedVatRate(QueryVatRate requestParameter)
        {
            ...
            var shapedData = _dataShaperGetVatRateViewModel.ShapeData(resultDataModel, String.Join(",", listFieldsModel));
